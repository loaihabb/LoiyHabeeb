<template>
  <main
    ...
    <div class="space-y-2 text-center md:text-left px-10">
      ...
      <h1 class="text-4xl font-bold md:text-5xl text-white fadein-up">Loiy Habeeb</h1>
      <div class="py-2">
        <h1
      ...
      <p class="text-white pr-4 fade-in-from-left pb-10">Welcome to My personal website. <span class="wave">👋🏼</span></p>
      <br>
      <br>
      <!-- <button
    ...
    <div class="flex justify-center md:justify-start fadein-right"><img alt="avatar" fetchpriority="high" width="300" height="300" decoding="async" data-nimg="1"
        class="w-20/12 md:h-auto rounded-full border-4 border-amber-200 pict" src="https://i.pinimg.com/564x/43/b0/59/43b059eb553f66b94f1bf4133df0e1bd.jpg">
    </div>
  </main>
</template>
...
export default {
  ...
  data() {
    return {
      toRotate: ["Web Developer", "Full-Stack Engineer", "Junior In Cyber Security"],
      period: 2000,
      txt: '',
      loopNum: 0,
      isDeleting: false,
