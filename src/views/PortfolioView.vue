      ...
      items: [
        {
          ...
          name: 'Mekan Bul',
          imageUrl: 'mekanbul',
          status: 'Is a project that uses MEAN technologies in its background to lists nearby venues by location.',
          tech: 'Mongodb, ExpressJS, Angular, NodeJS, Bootstrap',
          github: 'https://github.com/loaihabb/mekanbul',
          demo: 'null'
        },
        {
          id: 2,
          name: 'EldenEle',
          imageUrl: 'eldenEle',
          status: 'E-commerce site, a project using MERN technologies to buy or sell anything we want',
          tech: 'MongoDB, Firebase, Express, React, NodeJS',
          github: 'https://github.com/SDU-Bilgisayar-Muhendisligi/CengDarkwareExe',
          demo: 'null'
        },
        {
          id: 3,
          name: 'Netflix',
          imageUrl: 'netflix',
          status: 'This project is a Netflix clone developed using MongoDB, Express, React and Node.js (MERN) technologies.',
        ...
        },
        {
          ...
          name: 'Resturant Menu',
          imageUrl: 'resturant',
          status: 'Menu website listing the various dishes in the restaurant and display dishes by meal',
          tech: 'Css, html, Javascript, Bootstrap',
          github: 'https://github.com/loaihabb/Resturant-Menu',
          demo: 'null'
        },
        {
          id: 5,
          name: 'Key Logger',
          imageUrl: 'keyLogger',
          status: 'A type of software that monitors and records a users keyboard inputs.',
          tech: 'Python',
          github: 'https://github.com/loaihabb/Python--KeyLogger',
          demo: 'null'
        },
        {
          id: 6,
          name: 'Url Shortner',
          imageUrl: 'ulrShortner',
          status: 'It involves creating a system that makes long URLs shorter and shareable.',
          tech: 'Cors, Express, NodeJs',
          github: 'https://github.com/loaihabb/boilerplate-project-urlshortener',
          demo: 'null'
        }
      ]
    };
